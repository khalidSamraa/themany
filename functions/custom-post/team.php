...
function register_team_members() {
	$labels = [
		...
		"all_items" => __( "Team Members", "custom-post-type-ui" ),
		...
		"parent" => __( "Parent Team Member:", "custom-post-type-ui" ),
		...
		"item_reverted_to_draft" => __( "Team Member reverted to draft.", "custom-post-type-ui" ),
		"item_scheduled" => __( "Team Member scheduled", "custom-post-type-ui" ),
		"item_updated" => __( "Team Member updated.", "custom-post-type-ui" ),
		"parent_item_colon" => __( "Parent Team Member:", "custom-post-type-ui" ),
	];
